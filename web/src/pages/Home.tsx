...
const Home = () => {
    return (
        <div>
            <Navbar />
            <img className="w-100" src="https://source.unsplash.com/Z8K5AiK7s04/1600x800" alt="header" />
            <section>
                ...
                <div className="m-5">
                    <div className="row">
                        <div className="col-md-6 col-lg-3 col-xl-3 my-3 p-1">
                            <img className="w-100" src="https://source.unsplash.com/0BKZfcamvGg" alt="shoe" />
                            <div className="m-2">
                ...
                <div className="m-5">
                    <div className="row">
                        <div className="col-md-6 col-lg-3 col-xl-3 my-3">
                            <img className="w-100" src="https://source.unsplash.com/164_6wVEHfI" alt="shoe" />
                            <div className="m-2">
            ...
            <span className="mx-5 fs-4 fw-bold text-capitalize">Explore Top Brands</span>
                <div className="m-5">
                    <div className="row">
                        <div className="col-md-6 col-lg-3 col-xl-3 my-3 p-1">
                            <img className="w-100" src="https://source.unsplash.com/DMl5gG0yWWY" alt="shoe" />
                            <div className="m-2">
